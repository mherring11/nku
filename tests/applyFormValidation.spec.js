...
test.describe("Apply Form Validation", () => {
  ...
  test("Verify specific element is loaded on the apply form page", async ({ page }) => {
    console.log("Clicking on 'Apply Now' button...");
    const applyNowSelector = "#mega-menu-item-6330 > a"; // Selector for the Apply Now button
    await page.click(applyNowSelector);
    ...
    const specificElementSelector = 'div.elementor-element-8d72cd4.apply-page-form.elementor-widget'; // Selector for the specific element
    try {
      await page.waitForSelector(specificElementSelector, { state: 'visible', timeout: 60000 });
