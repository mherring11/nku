...
test.describe("Apply Form Validation", () => {
  ...
  test.beforeEach(async ({ page, context }) => {
    ...
    await page.goto("https://stage.onlinedegrees.nku.edu/"); // Navigate to the NKU online degrees homepage
  });
  ...
  test("Verify 'Apply Now' button leads to the apply form", async ({
    ...
    await expect(page).toHaveURL("https://stage.onlinedegrees.nku.edu/apply/"); // Updated URL
